#ifndef CORE_OPCODE_BMI_HPP
#define CORE_OPCODE_BMI_HPP
...
namespace core
{
    class opcode_bmi final : public opcode
    {
      public:
        opcode_bmi(addressing_mode init_addressing_mode, cpu &target_cpu)
