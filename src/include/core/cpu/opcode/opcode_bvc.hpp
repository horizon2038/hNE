#ifndef CORE_OPCODE_BVC_HPP
#define CORE_OPCODE_BVC_HPP
...
namespace core
{
    class opcode_bvc final : public opcode
    {
      public:
        opcode_bvc(addressing_mode init_addressing_mode, cpu &target_cpu)
