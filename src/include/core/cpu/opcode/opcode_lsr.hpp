#ifndef CORE_OPCODE_LSR_HPP
#define CORE_OPCODE_LSR_HPP
...
namespace core
{
    class opcode_lsr final : public opcode
    {
      public:
        opcode_lsr(addressing_mode init_addressing_mode, cpu &target_cpu)
