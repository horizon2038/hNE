#ifndef CORE_OPCODE_BPL_HPP
#define CORE_OPCODE_BPL_HPP
...
namespace core
{
    class opcode_bpl final : public opcode
    {
      public:
        opcode_bpl(addressing_mode init_addressing_mode, cpu &target_cpu)
        ...
        void execute() override
        {
            ...
            if (!root_cpu.registers.negative)
            {
