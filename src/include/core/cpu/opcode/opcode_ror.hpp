#ifndef CORE_OPCODE_ROR_HPP
#define CORE_OPCODE_ROR_HPP
...
namespace core
{
    class opcode_ror final : public opcode
    {
      public:
        opcode_ror(addressing_mode init_addressing_mode, cpu &target_cpu)
