#ifndef CORE_OPCODE_DCP_HPP
#define CORE_OPCODE_DCP_HPP
...
namespace core
{
    class opcode_dcp final : public opcode
    {
      public:
        opcode_dcp(addressing_mode init_addressing_mode, cpu &target_cpu)
            : mode { init_addressing_mode }
            , root_cpu { target_cpu }
        {
        }

        ~opcode_dcp() override = default;
        ...
        void execute() override
        {
            ...
            auto decremented_value = static_cast<uint8_t>(original_value - 1);
            ...
            root_cpu.update_negative(result);
        }
