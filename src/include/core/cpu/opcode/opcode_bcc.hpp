#ifndef CORE_OPCODE_BCC_HPP
#define CORE_OPCODE_BCC_HPP
...
namespace core
{
    class opcode_bcc final : public opcode
    {
      public:
        opcode_bcc(addressing_mode init_addressing_mode, cpu &target_cpu)
